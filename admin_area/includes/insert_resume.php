...
<body>
	<form name="resume" action="index.php?insert_resume"  method="post" enctype="multipart/form-data" onsubmit="return valid(this.form);" class="form-horizontal">
		...
		<div class="form-group col-sm-offset-1 col-sm-12">
			<input type ="text" name ="org" placeholder="Name of Organization/NGO/Self" class="form-control" />
		</div>
		<div = "row">
		<div class="form-group col-sm-offset-1 col-sm-6">
...
<?php
	if(isset($_POST['insert_post']))  {
		...
		if($insert_worker) {
            ...
            echo"<script>window.open('index.php?insert_resume','_self')</script>";
		}
	}
?>